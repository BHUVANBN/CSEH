# Day 10 — Practical: OSINT & Google Dorks
...
- **Tools:** Identified in topics: theHarvester, ExifTool, maltego, google dork operators site: filetype: inurl: intitle: cache:, github OSINT, spiderfoot, linkedin OSINT
...
```bash
mkdir -p ~/CEH_Labs/Week*/Day10
cd ~/CEH_Labs/Week*/Day10
```

### Phase 2: Core Practical Exercises

**3.** The main exercises for **OSINT & Google Dorks** follow the methodology below.

Topics covered hands-on: **theHarvester, ExifTool, maltego, google dork operators site: filetype: inurl: intitle: cache:, github OSINT, spiderfoot, linkedin OSINT**
...
# Document all output in ~/CEH_Labs/Week*/Day10/output.txt
```

**5.** Document findings:
```bash
# Redirect important output to a file for your report
command_output 2>&1 | tee ~/CEH_Labs/Week*/Day10/findings.txt
```

### Phase 3: Tool-Specific Exercises

**6.** For each tool identified in the topics (theHarvester, ExifTool, maltego, google dork operators site: filetype: inurl: intitle: cache:, github OSINT, spiderfoot, linkedin OSINT):
...
```bash
sudo tcpdump -i eth1 -w day10_capture.pcap &
# Run your tools
kill %1
```
...
```bash
sudo wireshark day10_capture.pcap &
```
...
### Primary Tools for OSINT & Google Dorks

```bash
# Tool syntax cheatsheet for: theHarvester, ExifTool, maltego, google dork operators site: filetype: inurl: intitle: cache:, github OSINT, spiderfoot, linkedin OSINT
